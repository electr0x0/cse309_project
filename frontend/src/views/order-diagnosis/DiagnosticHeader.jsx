...
const DiagnosticHeader = props => {
  // Props
  const { mode, searchValue, setSearchValue } = props

  // Vars
  const lightIllustration = '/images/diagnostics/medical-light.png'
  const darkIllustration = '/images/diagnostics/medical-dark.png'
    ...
    <Card className='relative flex justify-center'>
      ...
      <div className='flex flex-col items-center gap-4 max-md:pli-5 plb-12 md:is-1/2'>
        <Typography variant='h4' className='text-center md:is-3/4'>
          Comprehensive diagnostic services <span className='text-primary'>at your doorstep.</span>
        </Typography>
        <Typography className='text-center'>
          Choose from a wide range of tests offered by top diagnostic centers. Convenient, reliable, and hassle-free.
        </Typography>
        <div className='flex items-center gap-4 max-sm:is-full'>
          <CustomTextField
            placeholder='Search for tests or diagnostic centers'
            value={searchValue}
      ...
      <img
        src='/images/diagnostics/medical-dark.png'
